...
import 'package:flutter_application_sample/presentation/resources/style_manager.dart';
...
enum StateRendererType {
  ...
  EMPTY_SCREEN_STATE, // EMPTY VIEW WHEN WE RECEIVE NO DATA FROM API SIDE OF THE LIST SCREEN
}
            ...
            onPressed: () {
              if (stateRendererType ==
                ...
                Navigator.of(context)
                    .pop(); // pop up state error so we need to dismiss the dialog
              }
            },
            child: Text(
              buttonTitle,
